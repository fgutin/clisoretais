...
img=loadImage("geografia-quizz.png");
img1=loadImage("gege.jpg");
img2=loadImage("jeo.jpg");
img3=loadImage("jeje.jpg")
img4=loadImage("gio.jpg")
img5=loadImage("ffsfs.jpg")
img6=loadImage("WhatsApp Image 2020-07-27 at 15.06.04.jpeg")
img7=loadImage("20190109_200758.jpg")
...
function fase1(){
  ...
  textStyle(NORMAL)
    ...
    stroke(23)
    textAlign(LEFT);
    text( "QUESTÃO 1: Regiões que apresentam níveis muito elevados de altitude costumam apresentar climas mais frios, em função da menor pressão atmosférica existente nesse tipo de ambiente. O tipo de relevo que registra a ocorrência dos fenômenos acima apresentados é:",20,20,460,260);
  textSize(14)
    text("A) Depressões relativas."+"\n", 45, 150);
    text("B) Depressões absolutas."+"\n",45, 175);
    text("C) Planaltos."+"\n",45, 200);
    text("D) Cadeias de montanhas."+"\n",45, 225);
     drawPlacar()
}
...
function fase3(){
  ...
  textStyle(NORMAL)
    ...
    stroke(23)
    textAlign(LEFT);
    text( "QUESTÃO 3: O solo é um componente terrestre essencial para os seres vivos e também para a realização das atividades econômicas, de forma a ser considerado um importante recurso natural. Em termos de composição geomorfológica, pode-se afirmar que os solos.",20,20,480,260);
  textSize(13)
    text("A) Constituem-se em ambientes de erosão e acúmulo de material sedimentar."+"\n", 40, 150);
    text("B) Consolidam-se a partir de fatores exógenos do relevo."+"\n",40, 175);
    text("C) São o ponto de partida para a formação de todas as rochas terrestres."+"\n", 40, 200);
    text("D) Têm como característica a alteração mineralógica a partir da pressão do ar."+"\n",40, 225);
    drawPlacar()
}
function fase4(){
  background(img5);
...
function instrucoes(){
  ...
  textSize(16);
    stroke(1)
    textAlign(LEFT);
    text("Ano: 6º ano fundamental II."+"\n"+"Materia: Geografia,Relacionar padrões climáticos, tipos de solo, relevo e formações vegetais."+"\n"+"Resumo: O game é um quiz sobre a habilidade listada acima, onde os alunos de 6º ano terão perguntas que com o passar das fases ficarão mais contextualizadas e mais difícil a sua interpretação. O intuito é tentar estudar geografia de um jeito mais prático e rápido.",20,20,260,260);
...
function creditos(){
  ...
  textSize(16);
    ...
    text("Aluno: Flávio Augusto Silva de Oliveira."+"\n", 80, 300)
    text("Educadora: Joana Darc da Silva."+"\n",80,60,320,320)
}
